...
const resources = {
  ru: {
    translation: {
      ...
      "logout_success_description": "Вы успешно вышли из системы",
      "logout_failed": "Ошибка выхода",
      "logout_failed_description": "Не удалось выполнить выход",
      ...
      "registration_failed_exists": "Пользователь с таким именем уже существует",
      "create_username": "Придумайте имя пользователя",
      ...
      "material_needs_review": "Материалы требует проверки",
      "check_scenario_feedback": "Проверить отзыв о сценарии",
      "upload_material": "Загрузить Материалы",
      ...
      "project_deadlines": "Сроки проекта",
      ...
      "deadline_date": "Общий дедлайн",
      "scenario_deadline": "Дедлайн сценариев",
      "material_deadline": "Дедлайн материалов",
      "publication_deadline": "Дедлайн публикаций",
      ...
      "client_name": "Клиента",
      "no_key_requirements": "Нет ключевых требований",
      "no_platforms": "Нет платформ",
      "no_influencers_assigned": "Нет инфлюенсеров",
      "submit_for_approval": "Отправить на утверждение",
      "no_scenario_content": "Нет содержания сценария",
      "no_materials": "Нет материалов",
      "no_publications": "Нет публикаций",
      "complete_material_phase": "Завершите этап материалов",
      "complete_publication_phase": "Завершите этап публикаций",
      "complete_scenario_phase": "Завершите этап сценариев",
      "edit_project": "Редактировать проект",
      "delete_project": "Удалить проект",
      "delete_project_description": "Вы уверены, что хотите удалить этот проект?",
      "delete_project_confirm": "Удалить проект",
      "delete_project_cancel": "Отмена",
      "delete_project_success": "Проект успешно удален",
      "delete_project_confirmation": "Удалить проект?",
      "delete_project_warning": "Это действие необратимо и удалит все данные, связанные с проектом.",
      "project_to_delete": "Проект для удаления",
      "delete_project_permanent": "Вы точно хотите удалить проект?",
      ...
      "link_add_failed": "Не удалось добавить ссылку",
      "add_publication_links": "Добавить ссылки на публикации",
      "submit_publications": "Отправить публикации",
      "publication_submitted": "Публикация отправлена",
      "publication_submitted_success": "Публикация успешно добавления",
      ...
      "material_submitted": "Материалы отправлен",
      "material_approved": "Материалы утвержден",
      "material_rejected": "Материалы отклонен",
      ...
      "enter_key_requirement": "Введите ключевое требование",
      "enter_budget": "Введите бюджет",
      "enter_erid": "Введите ERID",
      "enter_link_title": "Введите название ссылки",
      "influencer_name": "Имя инфлюенсера",
      "select_influencer_placeholder": "Выберите инфлюенсера"
    }
  }
};
