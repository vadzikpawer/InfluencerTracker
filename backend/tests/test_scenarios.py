...
def test_create_scenario(client, test_token, test_project, test_influencer):
...
@pytest.mark.scenarios
def test_update_nonexistent_scenario(client, test_token, test_project, test_influencer):
